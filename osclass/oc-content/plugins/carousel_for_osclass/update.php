<?php 
     ...
     function update($version) {
      ...
      if($version <= '2.5') {
		  ...
		  osc_set_preference('carousel_version'     , '2.5','plugin-carousel_for_osclass','STRING');
	  }
	  if($version <= '2.5.1'){ 
		  osc_set_preference('carousel_limit'		, '15','plugin-carousel_for_osclass','INTEGER');
		  osc_set_preference('carousel_version'     , '2.5.1','plugin-carousel_for_osclass','STRING');
	  }
