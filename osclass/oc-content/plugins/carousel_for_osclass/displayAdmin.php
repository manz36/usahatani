<?php 
    ...
    if( Params::getParam('option') == 'stepone' ) {
        ...
        $dao_preference->update(array("s_value" => $limit), array("s_section" => "plugin-carousel_for_osclass", "s_name" => "carousel_limit"));
...
<form action="<?php osc_admin_base_url(true); ?>" method="post">
    ...
    <fieldset>
        ...
        <select name="item" id="item"> 
         ...
         <br />
        <label for="limit" style="font-weight: bold;"><?php _e('Limit the number of items to load into the carousel (Default is 15) ', 'carousel_for_osclass'); ?></label>:<br />
        <input type="text" name="limit" id="limit" value="<?php echo $limit; ?>" /><?php _e('(0 = no limit)','carousel_for_osclass'); ?>
        <br />
